...
export type ActionType = "deposit" | "borrow" | "withdraw" | "repay" | "mint" | "redeem" | "depositCollateral" | "withdrawCollateral";
export declare class SolendActionCore {
    ...
    private constructor();
    static initialize(pool: PoolType, reserve: ReserveType, action: ActionType, amount: BN, publicKey: PublicKey, connection: Connection, environment?: EnvironmentType, hostAta?: PublicKey): Promise<SolendActionCore>;
    static buildDepositTxns(pool: PoolType, reserve: ReserveType, connection: Connection, amount: string, publicKey: PublicKey, environment?: EnvironmentType): Promise<SolendActionCore>;
