...
class SolendWallet {
    ...
    static initialize(wallet, connection, environment = "production") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = typeof environment == "string" ? (yield (yield axios_1.default.get(`${API_ENDPOINT}/v1/markets/configs?scope=all&deployment=${environment}`)).data) : environment.marketConfigs;
    ...
    loadRewards() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const optionAtas = yield Promise.all(optionMarkets.map((om) => om
                ? (0, spl_token_1.getAssociatedTokenAddress)(new web3_js_1.PublicKey(om.optionMint), this.provider.wallet.publicKey, true)
            ...
            const parsedOptionBalances = optionBalances.map((om, index) => om ? (0, spl_token_1.unpackAccount)(optionAtas[index], om) : null);
            ...
            const fullData = yield Promise.all(claimData.map((d, index) => __awaiter(this, void 0, void 0, function* () {
                ...
                return Object.assign(Object.assign({}, d), { optionMarket: om
                        ? Object.assign(Object.assign({}, om), { userBalance: Number((_b = (_a = parsedOptionBalances[index]) === null || _a === void 0 ? void 0 : _a.amount) !== null && _b !== void 0 ? _b : 0), expired: om.expirationUnixTimestamp.toNumber() <=
