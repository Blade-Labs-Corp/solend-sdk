...
export type CustomEnviromentConfigType = {
    pythProgramID: string;
    switchboardProgramID: string;
    programID: string;
    marketConfigs: Array<MarketConfigType>;
};
export type EnviromentConfig = "mainnet-beta" | "devnet" | "testnet" | "production" | "beta" | CustomEnviromentConfigType;
