...
exports.getProgramId = exports.SOLEND_BETA_PROGRAM_ID = exports.SOLEND_DEVNET_PROGRAM_ID = exports.SOLEND_PRODUCTION_PROGRAM_ID = exports.U64_MAX = exports.WANG = exports.WAD = void 0;
...
function getProgramId(environment) {
    if (environment && typeof environment != "string") {
        return new web3_js_1.PublicKey(environment.programID);
    }
    switch (environment) {
        case "mainnet-beta":
        case "production":
