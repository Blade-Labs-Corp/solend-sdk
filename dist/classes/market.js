...
class SolendMarket {
    ...
    fetchObligationByWallet(publicKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parsedObligation = (0, state_1.parseObligation)(web3_js_1.PublicKey.default, rawObligationData);
            if (!parsedObligation) {
    ...
    loadRewards() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const querySymbols = [
                ...Array.from(new Set(externalRewards.map((reward) => reward.rewardSymbol))),
            ];
