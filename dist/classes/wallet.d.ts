...
import { ConfigType, EnviromentConfig } from "./shared";
...
export declare class SolendWallet {
    ...
    programId: PublicKey;
    private constructor();
    static initialize(wallet: anchor.Wallet, connection: Connection, environment?: EnviromentConfig): Promise<SolendWallet>;
