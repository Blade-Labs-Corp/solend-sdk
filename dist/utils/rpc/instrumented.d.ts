...
export declare class InstrumentedConnection implements SolendRPCConnection {
    connection: SolendRPCConnection;
    statsd: StatsD;
    prefix: string;
    rpcEndpoint: string;
    constructor(connection: SolendRPCConnection, statsd: StatsD, prefix?: string);
    ...
    withStats(fn: Promise<any>, fnName: string): Promise<any>;
}
